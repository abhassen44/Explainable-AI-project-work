"""
train_2dcnn.py — Train the 2D-CNN on NSL-KDD (paper-accurate config)
...
5. Reshape 36 features → 6 × 6 × 1
6. Train 2D-CNN for 20 epochs with Adam(lr=0.001, weight_decay=0.0001)
7. Save model + preprocessors

Outputs:
  - 2dcnn_model.keras
  - preprocessors_2dcnn.pkl
"""
...
MODEL_SAVE_PATH         = '2dcnn_model.keras'
PREPROCESSOR_SAVE_PATH  = 'preprocessors_2dcnn.pkl'
...
# Drop 5 highly-correlated features → keeps 36 features → 6×6 grid (paper spec)
DROP_COLS = [
...
# 5-class names in label-encoded order
...
def main():
    ...
    print("2/4  Preprocessing (5-class mapping, 36 features → 6×6) …")
    ...
    # ---- 3. Train ----
    print("3/4  Training 2D-CNN (20 epochs) …")
